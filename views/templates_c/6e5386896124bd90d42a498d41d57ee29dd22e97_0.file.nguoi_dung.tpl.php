  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post">
        <h2 class="form-signin-heading">Ðang nh?p</h2>
        <label for="inputEmail" class="sr-only">Email address</label>
        <input type="text" id="ten_dang_nhap" name="ten_dang_nhap" class="form-control" placeholder="Nh?p tài kho?n" required autofocus>
        ...
        <button class="btn btn-lg btn-primary btn-block" name="btnDangNhap" value="Ðang nh?p" type="submit">Sign in</button>
      </form>
